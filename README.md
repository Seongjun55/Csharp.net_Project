...
## 💡 Future Improvements
1.  Secure storage for API Key.
2. ~Change the forecast time to local time~ (Clear, 45th commit)
3. Loading animations during API calls.
4. Support for additional weather metrics (UV index, air quality, etc)
